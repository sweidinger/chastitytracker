...
export const MESSAGE_BODY_KEYS = [
  ...
  // Fork-Erweiterungen: Belohnungs-Ökonomie, Gesundheits-Hold, Pausen-Überzug, Straf-Erledigung, Schicksalsrad
  "rewardEarnedMessage",
  "rewardRevokedMessage",
  "rewardPostponedMessage",
  "healthHoldOnMessage",
  "healthHoldOffMessage",
  "pauseExpiredMessageSub",
  "pauseExpiredMessageKeyholder",
  "penaltyReportedMessage",
  "penaltyReportedMessagePlain",
  "penaltyConfirmedMessage",
  "penaltyConfirmedMessagePlain",
  "penaltyRejectedMessage",
  "zufallResultMessage",
] as const;
